...
<?php if(isset($mainVids)):?> 
    <div class="col-md-6 pl-0 pr-1">
        <div class="card">
            <img class="card-img-top" src="https://img.youtube.com/vi/<?= $mainVids->items[0]->id->videoId?>/mqdefault.jpg" alt="">
            <div class="imagenews p-1">
                <h4>
                    <a class="play_vid text-white" href="https://www.youtube.com/watch?v=<?= $mainVids->items[0]->id->videoId?>" class="text-white">
                        <?= ucfirst($mainVids->items[0]->snippet->title)?>
                    </a>
                </h4>
            </div>
        </div>
    ...
    <div class="col-md-6 pr-1 pl-1 pt-0">
        <div class="row">
            <div class="col-6 pr-1">
                <div class="card">  
                    <img class="card-img-top" src="https://img.youtube.com/vi/<?= $mainVids->items[1]->id->videoId?>/mqdefault.jpg" alt="">
                    <div class="imagenews p-2">
                        <h6>
                            <a class="play_vid text-white" href="https://www.youtube.com/watch?v=<?= $mainVids->items[1]->id->videoId?>" class="text-white">
                                <?= ucfirst($mainVids->items[1]->snippet->title)?>
                            </a>
                        </h6>
                    </div>
                </div>
            ...
            <div class="col-6 pl-1">
                <div class="card">
                    <img class="card-img-top" src="https://img.youtube.com/vi/<?= $mainVids->items[2]->id->videoId?>/mqdefault.jpg" alt="">
                    <div class="imagenews p-2">
                        <h6>
                            <a class="play_vid text-white" href="https://www.youtube.com/watch?v=<?= $mainVids->items[2]->id->videoId?>" class="text-white">
                                <?= ucfirst($mainVids->items[2]->snippet->title)?>
                            </a>
                        </h6>
                    </div>
                </div>
        ...
        <div class="row pt-2">
            <div class="col-6 pr-1">
                <div class="card">
                    <img class="card-img-top" src="https://img.youtube.com/vi/<?= $mainVids->items[3]->id->videoId?>/mqdefault.jpg" alt="">
                    <div class="imagenews p-2">
                        <h6>
                            <a class="play_vid text-white" href="https://www.youtube.com/watch?v=<?= $mainVids->items[3]->id->videoId?>" class="text-white">
                                <?= ucfirst($mainVids->items[3]->snippet->title)?>
                            </a>
                        </h6>
                    </div>
                </div>
            ...
            <div class="col-6 pl-1">
                ...
                <img class="card-img-top" src="https://img.youtube.com/vi/<?= $mainVids->items[4]->id->videoId?>/mqdefault.jpg" alt="">
                    <div class="imagenews p-2">
                        <h6>
                            <a class="play_vid text-white" href="https://www.youtube.com/watch?v=<?= $mainVids->items[4]->id->videoId?>" class="text-white">
                                <?= ucfirst($mainVids->items[4]->snippet->title)?>
                            </a>
                        </h6>
                    </div>
                </div>
